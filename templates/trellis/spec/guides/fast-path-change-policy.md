...
If the workspace has unrelated changes or the fix is risky, stop and explain that the request should use `/coding <task-id>` for a prepared full Trellis task, or be retried after the workspace is clean.
